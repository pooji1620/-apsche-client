    ...
    <div className="landing-page">
        ...
        <div className="landing-hero">
            ...
            <div className="landing-hero-text">
                ...
                <p>Discover a platform that empowers creators, developers, and professionals to connect, collaborate, and grow. Whether you're just starting out or scaling up, SB Works is where your journey begins.</p>
